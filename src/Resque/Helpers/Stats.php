...
class Stats
{
     ...
     */
    public static function get($stat, $key = self::DEFAULT_KEY)
    {
     ...
     */
    public static function incr($stat, $by = 1, $key = self::DEFAULT_KEY)
    {
     ...
     * @return bool True if successful, false if not
     */
    public static function decr($stat, $by = 1, $key = self::DEFAULT_KEY)
    {
     ...
     * @return bool True if successful, false if not
     */
    public static function clear($stat, $key = self::DEFAULT_KEY)
    {
